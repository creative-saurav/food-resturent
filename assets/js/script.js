$("document").ready(function(){
    ...
    // choose date
    $('.single-date label').click(function() {
      $(".single-date label").removeClass("active");
      $(this).addClass("active");
    });
    // choose time
    $('.hours-select label').click(function() {
      $(".hours-select label").removeClass("active");
      $(this).addClass("active");
    });
    $('.min-select label').click(function() {
      $(".min-select label").removeClass("active");
      $(this).addClass("active");
    });
    // choose time
    $('.select-period label').click(function() {
      $(".select-period label").removeClass("active");
      $(this).addClass("active");
    });
    // Booking Table Chose Data
    $('.select-date-slide').slick({
        centerPadding: '0px',
        infinite: true,
        slidesToShow: 5,
        slidesToScroll: 5,
